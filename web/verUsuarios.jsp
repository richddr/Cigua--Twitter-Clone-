<%-- 
    ...
    Created on : Jul 25, 2014, 12:43:35 AM
    Author     : Richard
--%>
...
<%
    //Se Supone que se le manda el username y el tipo de accion(following/followers)
    ...
    if (lu != null) {
        if (user != null) {
            if (tipo != null) {
                if (tipo.equals("followers")) {
                    followers = true;
                    users = ts.getFollowers(user);
                } else if (tipo.equals("following")) {
                    following = true;
                    users = ts.getFollowing(user);
                }
            } else {
                //no se especifico el tipo
            }
        } else {
            //usuario con dicho username no existe
        }
    } else {
                                    ...
                                    <div class="DashboardProfileCard-content">
                                        ...
                                        <div class="home-tweet-box tweet-box component tweet-user
                                            ...
                                            <form name="formCrearTweet" action="./ct" method="POST" enctype="multipart/form-data" class="t1-form tweet-form condensed">
                                                <br>Contenido<br><textarea rows="5" cols="70" name="contenido" maxlength="200">@</textarea><br>
                                                <br>Imagen(Opcional): <input type="file" value="" name="imagenTweet"/><br><br>
                                                Tweet Publico:<input type="checkbox" value="yes" name="isPublic" checked/><br>
                                ...
                                <div class="content-header">
                                    <div class="header-inner">
                                        <h2 id="content-main-heading" class="js-timeline-title">
                                            <c:choose>
                                                <c:when test="<%=following == true && followers == false%>">
                                                    Following
                                                </c:when>
                                                <c:when test="<%=followers ==true && following == false%>">
                                                    Followers
                                                </c:when>
                                            </c:choose>
                                        </h2>
                                    ...
                                    <div class="stream home-stream">
                                        <ol class="stream-items js-navigable-stream" id="stream-items-id">  
                                            <c:choose>
                                                ...
                                                <c:when test="<%=users.size() == 0 || users == null%>">
                                                    <br>Usted no tiene followers/following.<br>
                                                </c:when>
                                            </c:choose>
