<%-- 
    Document   : index
    Created on : Jul 1, 2014, 6:52:52 PM
    Author     : Richard
--%>
...
<%@page import="edu.pucmm.pw.parcial2.entidades.Hashtag"%>
...
<%
    ...
    //se busca el usuario logueado si existe
    ...
    if (user != null) {
        ...
        followingCount = ts.getFollowersCount(user); 
        followerCount = ts.getFollowingCount(user);
        timeline = ts.getTimeline(user);//TL incluyendo tweet de las personas a que el usuario sigue
    }
                                        ...
                                        <ul class="nav js-global-actions" id="global-actions">
                                            <li id="global-nav-home" class="home active" data-global-action="home"> 
                                                <a class="js-nav" href="./index.jsp" data-component-term="home_nav" data-nav="home" title="Home"> 
                                                    ...
                                                    <span class="text">Portada</span> </a> 
                                            </li>
                                            <li class="topics" data-global-action="discover"></li>  
                                            <li class="profile" data-global-action="profile"> 
                                                <a class="js-nav" href="./verPerfil.jsp?username=<%=user.getUsername()%>" data-component-term="profile_nav" data-nav="profile" title="Me"> 
                                                    <span class="Icon Icon--me Icon--large"></span> 
                                                    <span class="text">Mi Perfil</span> </a> 
                                            </li> 
                                        </ul>
                                    </div>
                                    ...
                                    <div class="pull-right" style="display: inline-block;"> 
                                        <div role="search" class="">
                                            <form class="t1-form form-search js-search-form" action="./search.jsp" id="global-nav-search">
                                                <label class="visuallyhidden" for="search-query">Buscar</label>
                                    ...
                                    <div class="DashboardProfileCard-content">
                                        ...
                                        <div class="DashboardProfileCard-userFields">
                                            ...
                                            <span class="DashboardProfileCard-screenname u-inlineBlock u-dir" dir="ltr">
                                                <a class="DashboardProfileCard-screennameLink u-linkComplex u-linkClean" href="./verPerfil.jsp?username=<%=user.getUsername()%>">@<span class="u-linkComplex-target"><%=user.getUsername()%></span></a>
                                            </span>
                                        </div>
                                        ...
                                        <div class="home-tweet-box tweet-box component tweet-user
                                             DashboardProfileCard-tweetbox u-bgUserColorLightest u-borderUserColorLighter">
                                                                                       <form name="formCrearTweet" action="./ct" method="POST" enctype="multipart/form-data" class="t1-form tweet-form condensed">
                                                                                           Contenido<br><textarea rows="5" cols="105" name="contenido" maxlength="200" ></textarea><br>
                                            ...
                                            <li class="js-stream-item stream-item stream-item expanding-stream-item" data-item-id="484430288244572162" id="stream-item-tweet-484430288244572162" data-item-type="tweet">
                                                ...
                                                <%
                                                    ...
                                                    for (int i = 0; i < timeline.size(); i++) {
                                                       ...
                                                       //  File flImagen = new File("./"+t.getImagen());
                                                        if(t.getImagen() != null){
                                                            tieneImagen = true;
                                                        }
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="stream-item-header">
                                                            ...
                                                            <a class="account-group js-account-group js-action-profile js-user-profile-link js-nav" href="./verPerfil.jsp?username=<%=t.getIdUsuario().getUsername()%>">
                                                                ...
                                                                <span>
                                                                    </span><span class="username js-action-profile-name"><s>@</s><b><%=t.getIdUsuario().getUsername()%></b></span> </a>
    ...
    <c:when test="<%= user == null%>">
        ...
        <html lang="en" data-scribe-reduced-action-queue="true">
            <head>
                ...
                <meta charset="utf-8">
                <link rel="stylesheet" href="https://abs.twimg.com/a/1404619576/css/t1/highline_rosetta_gotham_core.bundle.css">
                <link rel="stylesheet" href="https://abs.twimg.com/a/1404619576/css/t1/rosetta_gotham_logged_out.bundle.css">
                <link rel="stylesheet" href="https://abs.twimg.com/a/1404619576/css/t1/highline_logged_out.bundle.css">
                <link rel="stylesheet" href="https://abs.twimg.com/a/1404619576/css/t1/rosetta_gotham_more.bundle.css">
                <link rel="stylesheet" href="https://abs.twimg.com/a/1404619576/css/t1/highline_more.bundle.css">
                <link rel="stylesheet" href="https://abs.twimg.com/font/gotham-narrow-v3.css">
                <title>Cigua - Parcial #2 Microblogging</title>
            </head>
            <body class="highline three-col logged-out ms-windows world-cup-2014 front-page" data-fouc-class-names="swift-loading" dir="ltr">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <ul class="nav secondary-nav session-dropdown" id="session"> 
                                            <li class="dropdown js-session"> 
                                                <a href="https://twitter.com/login" class="dropdown-toggle js-dropdown-toggle dropdown-signin" id="signin-link" data-nav="login"> 
                                                ...
                                                <a href="https://twitter.com/signup?context=login" class="dropdown-signup" id="signup-link" data-nav="signup"> 
                                                    <small>New to Twitter?</small> 
                                                    <span class="emphasize"> Join Today »</span> 
                                                </a> 
                    ...
                    <div id="page-outer">
                        <div id="page-container" class="AppContent  wrapper-front white">
                            <div class="front-container front-container-full-signup" id="front-container">
                                <div class="front-bg">
                                    <img class="front-image" src="./media/images/exp_wc2014_gen_laurenlemon.jpg" alt="" style="display: block;">
                                </div>
                                <%
                                    ...
                                    if (error != null) {
                                        if (error.equals("login")) {
                                            mensaje = "El username/clave digitado fue incorrecto.";
                                            err = true;
                                        } else if (error.equals("useduser")) {
                                            mensaje = "UsuarioID ya esta siendo utilizado...usar uno diferente.";
                                            err = true;
                                        } else if (error.equals("notext")) {
                                            mensaje = "Debe especificar por lo menos el UsuarioID y la clave..";
                                            err = true;
                                        } else if (error.equals("datewrong")) {
                                            mensaje = "La fecha selecionada no es valida";
                                            err = true;
                                        }
                                    }
                                ...
                                <div class="front-card">
                                    <div class="front-welcome">
                                        ...
                                        <div class="front-welcome-text">
                                            <h1>Bienvenidos a Cigua</h1>
                                            <p>Cigua es un sistema de microblogging realizado para la materia de programacion web.</p>
                                            <p>&nbsp;</p>
                                            <p>David De La Hoz &amp; Richard Garcia</p>
                                        </div>
                                    </div>

                                    <div class="front-signin js-front-signin">
                                        <form name="formLogin" action="./login.jsp" method="POST" class="t1-form signin">    
                                            <div class="username">
                                                <input type="text" id="signin-email" class="text-input email-input" name="username" autocomplete="on" placeholder="Usuario">
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="flex-table-primary">
                                                            <div class="password flex-table-form">
                                                                <input type="password" id="signin-password" class="text-input flex-table-input" name="password" placeholder="Contraseña">
                                                            </div>
                                                        </td>
                                    ...
                                    <div class="front-signup js-front-signup" style="height:280px;">
                                        <h2><strong>Nuevo en Cigua? </strong>Registrate</h2>
                                        <form name="formCrearUsuario" action="./cu" method="POST" enctype="multipart/form-data" class="t1-form signup" id="frontpage-signup-form">
                                            <div class="field">
                                                <input type="text" class="text-input" autocomplete="on" name="username" maxlength="20" placeholder="Usuario">
                                            </div>
                                            <div class="field">
                                                <input type="text" class="text-input" autocomplete="on" name="nombre" maxlength="20" placeholder="Nombre Completo">
                                            </div>
                                            <div class="field">
                                                <input type="date" class="text-input" autocomplete="on" name="fechaNacimiento" placeholder="Fecha Nacimiento">
                                            </div>
                                            ...
                                            <div class="field">
                                                <input type="file" class="file-input" autocomplete="on" name="fotoUsuario" placeholder="Foto">
                                            </div>
                                ...
                                <div class="footer inline-list">
                                    <ul>
                                        <li><span class="copyright">© 2014 Cigua</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
